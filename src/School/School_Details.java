...
public class School_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton11.setText("Set School Profile");
        ...
        jButton11.setBounds(10, 10, 220, 30);

        jButton1.setBackground(new java.awt.Color(0, 0, 255));
        jButton1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(0, 255, 255));
        jButton1.setText("View School Profile");
        ...
        jButton9.setBounds(10, 360, 220, 30);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(0, 70, 260, 630);
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(200, 10, 960, 50);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(0, 0, 1380, 70);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 0, 1380, 700);

        setSize(new java.awt.Dimension(1392, 742));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // Button Of Setup School Profile
        School_Profile sp=new School_Profile();
        sp.setVisible(true);
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      // Button Of View School Profile
        Show_School_Profile ssp=new Show_School_Profile();
        ssp.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // Button OF View All Student
        View_Exam_Routine ex=new View_Exam_Routine();
        ex.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        AdmitCard_view am=new AdmitCard_view();
        am.setVisible(true);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        View_ID_Card vic=new View_ID_Card();
        vic.setVisible(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        View_Registation_card vrc=new View_Registation_card();
        vrc.setVisible(true);
